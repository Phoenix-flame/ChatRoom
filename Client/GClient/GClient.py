...
@app.route('/')
@app.route('/<data>/<isfromother>')
def main():
    url_for('static', filename='css/bootstrap.min.css')
    return render_template('GClient.html', data=data, isfromother=isfromother)
...
def my_form_post(msg = None, other=False):
    if other:
        ...
        received_msg.append({"msg":text, "ip":"127.0.0.1"})
        data.append({"msg":text, "ip":"127.0.0.1"})
